...
//               throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
                ...
                int post_id = postid;
                try {
                    HttpResponse<String> httpResponse = Unirest.get(GlobalClass.serverAddress + "getAllStories")
                            .queryString("loggedinuser", username)
                    ...
                    if (httpResponse.getStatus() == 200) {
                        ...
                        if (count == 0) {
                            ...
                            while (st.hasMoreTokens()) {
                                ...
                                System.out.println(story_id + "......" + caption + "......" + photo);
                            ...
                            for (int j = 0; j < al.size(); j++) {
                                ...
                                try {
                                    URL url = new URL(GlobalClass.serverAddress + "GetResource/" + al.get(j));
